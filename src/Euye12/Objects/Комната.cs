...
namespace IIS.Euye12
{
    ...
    public class Комната : ICSSoft.STORMNET.DataObject
    {
        ...
        [PropertyStorage(new string[] {
                "Дом"})]
        [NotNull()]
        public virtual IIS.Euye12.Дом Дом
        {
            get
            {
                ...
                IIS.Euye12.Дом result = this.fДом;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View КомнатаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КомнатаE", typeof(IIS.Euye12.Комната));
                }
            }
            ...
            public static ICSSoft.STORMNET.View КомнатаL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КомнатаL", typeof(IIS.Euye12.Комната));
                }
            }
        }
    }
