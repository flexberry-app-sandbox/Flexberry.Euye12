...
namespace IIS.Euye12
{
    ...
    public class Улица : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Euye12.DetailArrayOfГород fГород;
        ...
        public virtual IIS.Euye12.DetailArrayOfГород Город
        {
            get
            {
                ...
                if ((this.fГород == null))
                {
                    this.fГород = new IIS.Euye12.DetailArrayOfГород(this);
                }
                IIS.Euye12.DetailArrayOfГород result = this.fГород;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View УлицаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("УлицаE", typeof(IIS.Euye12.Улица));
                }
            }
            ...
            public static ICSSoft.STORMNET.View УлицаL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("УлицаL", typeof(IIS.Euye12.Улица));
                }
            }
        }
    }
